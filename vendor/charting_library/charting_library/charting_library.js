    ...
    if (!window.TradingView) {
        var h = {
            ...
            d = {
                ...
                HOLLOW_CANDLES: 9,
                version: function() {
                    return "1.8 (internal id 9b572a49 @ 2016-12-08 22:17:14.612279)"
                },
                gEl: function(a) {
                ...
                widget: function(a) {
                    ...
                    a.preset && (a = a.preset, h[a] ? (a = h[a], this.options.disabledFeatures = 0 < this.options.disabledFeatures.length ? this.options.disabledFeatures.concat(a.disabledFeatures) : a.disabledFeatures, this.options.enabledFeatures = 0 < this.options.enabledFeatures.length ? this.options.enabledFeatures.concat(a.enabledFeatures) :
        ...
        d.widget.prototype = {
            ...
            create: function() {
                ...
                if (this.options.autosize || this.options.fullscreen) e = $(d.gEl(this.id)),
                    e.css("width", "100%"), this.options.fullscreen || e.css("height", "100%");
