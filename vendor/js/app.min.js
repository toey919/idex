		...
		g = function() {
			if (
				...
				$("body").on("click", "a.btn, button.btn, input.btn, label.btn", function(n) {
					;(t = $(this)), 0 == t.find(".md-click-circle").length && t.prepend("<span class='md-click-circle'></span>"), (e = t.find(".md-click-circle")), e.removeClass("md-click-animate"), e.height() ||
						e.width() ||
						(
						...
						), (a = n.pageX - t.offset().left - e.width() / 2), (i = n.pageY - t.offset().top - e.height() / 2), e
						.css({
							top: i + "px",
							left: a + "px"
						})
